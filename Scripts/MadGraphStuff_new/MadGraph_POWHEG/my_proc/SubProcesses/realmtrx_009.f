...
C ----------
      ...
      CALL HIOXXX(W(1,2   ),W(1,4   ),GULN2M ,MCL     ,WCL     ,W(1,       
     &     6   ))                                                          
      CALL FVOXXX(W(1,1   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,7   ))     
      CALL IOSXXX(W(1,3   ),W(1,7   ),W(1,6   ),GULN1P ,AMP(1   ))         
      CALL HIOXXX(W(1,2   ),W(1,4   ),GURN2M ,MCR     ,WCR     ,W(1,       
     &     8   ))                                                          
      CALL IOSXXX(W(1,3   ),W(1,7   ),W(1,8   ),GURN1P ,AMP(2   ))         
      CALL HIOXXX(W(1,3   ),W(1,1   ),GULN1P ,MCL     ,WCL     ,W(1,       
     &     9   ))                                                          
      CALL FSOXXX(W(1,4   ),W(1,9   ),GULN2M ,ZERO    ,ZERO    ,W(1,       
     &     10  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,10  ),W(1,5   ),GG ,AMP(3   ))             
      CALL HIOXXX(W(1,3   ),W(1,1   ),GURN1P ,MCR     ,WCR     ,W(1,       
     &     11  ))                                                          
      CALL FSOXXX(W(1,4   ),W(1,11  ),GURN2M ,ZERO    ,ZERO    ,W(1,       
     &     12  ))                                                          
     ...
     &     13  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,7   ),W(1,13  ),GZU ,AMP(7   ))            
      CALL FVIXXX(W(1,2   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,14  ),W(1,1   ),W(1,13  ),GZU ,AMP(8   ))            
      CALL IXXXXX(P(0,1   ),ZERO ,NHEL(1   ),+1*IC(1   ),W(1,15  ))        
      CALL OXXXXX(P(0,3   ),MN1 ,NHEL(3   ),+1*IC(3   ),W(1,16  ))         
      CALL HIOXXX(W(1,2   ),W(1,16  ),GULN1M ,MCL     ,WCL     ,W(1,       
     &     17  ))                                                          
      CALL FSOCXX(W(1,4   ),W(1,17  ),GULN2P  ,ZERO    ,ZERO    ,W(1,      
     &     18  ))                                                          
      CALL IOVCXX(W(1,15  ),W(1,18  ),W(1,5   ),GG  ,AMP(9   ))            
      CALL HIOXXX(W(1,2   ),W(1,16  ),GURN1M ,MCR     ,WCR     ,W(1,       
     &     19  ))                                                          
      CALL FSOCXX(W(1,4   ),W(1,19  ),GURN2P  ,ZERO    ,ZERO    ,W(1,      
     &     20  ))                                                          
      CALL IOVCXX(W(1,15  ),W(1,20  ),W(1,5   ),GG  ,AMP(10  ))            
      CALL HIOCXX(W(1,15  ),W(1,4   ),GULN2P  ,MCL     ,WCL     ,W(1,      
     &     21  ))                                                          
      CALL IOSXXX(W(1,14  ),W(1,16  ),W(1,21  ),GULN1M ,AMP(11  ))         
      CALL HIOCXX(W(1,15  ),W(1,4   ),GURN2P  ,MCR     ,WCR     ,W(1,      
     &     22  ))                                                          
      CALL IOSXXX(W(1,14  ),W(1,16  ),W(1,22  ),GURN1M ,AMP(12  ))         
      CALL VSSXXX(W(1,5   ),W(1,21  ),W(1,17  ),GC ,AMP(13  ))             
      CALL VSSXXX(W(1,5   ),W(1,22  ),W(1,19  ),GC ,AMP(14  ))             
