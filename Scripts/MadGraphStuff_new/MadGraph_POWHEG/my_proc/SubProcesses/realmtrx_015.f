...
C ----------
     ...
     &     13  ))                                                          
      ...
      CALL HIOCXX(W(1,15  ),W(1,4   ),GDLN2P  ,MSL     ,WSL     ,W(1,      
     &     17  ))                                                          
      CALL IOSXXX(W(1,14  ),W(1,16  ),W(1,17  ),GDLN1M ,AMP(9   ))         
      CALL HIOCXX(W(1,15  ),W(1,4   ),GDRN2P  ,MSR     ,WSR     ,W(1,      
     &     18  ))                                                          
