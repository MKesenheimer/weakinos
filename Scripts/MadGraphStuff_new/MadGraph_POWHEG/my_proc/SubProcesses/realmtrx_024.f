...
C ----------
     ...
     &     8   ))                                                          
      ...
      CALL HIOXXX(W(1,3   ),W(1,5   ),GULN1P ,MUL     ,WUL     ,W(1,       
     &     9   ))                                                          
      CALL VSSXXX(W(1,1   ),W(1,9   ),W(1,6   ),GC ,AMP(3   ))             
      CALL HIOXXX(W(1,3   ),W(1,5   ),GURN1P ,MUR     ,WUR     ,W(1,       
     &     10  ))                                                          
      CALL VSSXXX(W(1,1   ),W(1,10  ),W(1,8   ),GC ,AMP(4   ))             
      CALL FVIXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL HIOXXX(W(1,11  ),W(1,4   ),GULN2M ,MUL     ,WUL     ,W(1,       
     &     12  ))                                                          
      CALL IOSXXX(W(1,3   ),W(1,5   ),W(1,12  ),GULN1P ,AMP(5   ))         
      CALL HIOXXX(W(1,11  ),W(1,4   ),GURN2M ,MUR     ,WUR     ,W(1,       
     &     13  ))                                                          
      CALL IOSXXX(W(1,3   ),W(1,5   ),W(1,13  ),GURN1P ,AMP(6   ))         
      CALL JIOXXX(W(1,3   ),W(1,4   ),GZN12 ,ZMASS   ,ZWIDTH  ,W(1,        
     &     14  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,7   ),W(1,14  ),GZU ,AMP(7   ))            
      CALL IOVXXX(W(1,11  ),W(1,5   ),W(1,14  ),GZU ,AMP(8   ))            
