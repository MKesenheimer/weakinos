...
C ----------
      ...
      CALL HIOXXX(W(1,3   ),W(1,1   ),GDLN1P ,MSL     ,WSL     ,W(1,       
     &     6   ))                                                          
      CALL FSOXXX(W(1,4   ),W(1,6   ),GDLN2M ,ZERO    ,ZERO    ,W(1,       
     &     7   ))                                                          
      CALL IOVXXX(W(1,5   ),W(1,7   ),W(1,2   ),GG ,AMP(1   ))             
      CALL HIOXXX(W(1,3   ),W(1,1   ),GDRN1P ,MSR     ,WSR     ,W(1,       
     &     8   ))                                                          
     ...
     &     9   ))                                                          
      ...
      CALL HIOXXX(W(1,3   ),W(1,12  ),GDLN1P ,MSL     ,WSL     ,W(1,       
     &     13  ))                                                          
      CALL IOSXXX(W(1,5   ),W(1,4   ),W(1,13  ),GDLN2M ,AMP(5   ))         
      CALL HIOXXX(W(1,3   ),W(1,12  ),GDRN1P ,MSR     ,WSR     ,W(1,       
     &     14  ))                                                          
