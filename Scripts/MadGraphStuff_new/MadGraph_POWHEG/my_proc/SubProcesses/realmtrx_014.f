...
C ----------
     ...
     &     15  ))                                                          
      ...
      CALL HIOCXX(W(1,17  ),W(1,4   ),GDLN1P  ,MSL     ,WSL     ,W(1,      
     &     19  ))                                                          
      CALL IOSXXX(W(1,16  ),W(1,18  ),W(1,19  ),GDLN1M ,AMP(9   ))         
      CALL HIOCXX(W(1,17  ),W(1,4   ),GDRN1P  ,MSR     ,WSR     ,W(1,      
     &     20  ))                                                          
     ...
     &     22  ))                                                          
      ...
      CALL HIOCXX(W(1,23  ),W(1,4   ),GDLN1P  ,MSL     ,WSL     ,W(1,      
     &     24  ))                                                          
      CALL IOSXXX(W(1,5   ),W(1,18  ),W(1,24  ),GDLN1M ,AMP(13  ))         
      CALL HIOCXX(W(1,23  ),W(1,4   ),GDRN1P  ,MSR     ,WSR     ,W(1,      
     &     25  ))                                                          
