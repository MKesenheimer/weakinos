...
C ----------
     ...
     &     5   ))                                                          
      CALL IOSXXX(W(1,2   ),W(1,4   ),W(1,5   ),GDLN1M ,AMP(1   ))         
      CALL HIOXXX(W(1,3   ),W(1,1   ),GDRN1P ,MSR     ,WSR     ,W(1,       
     &     6   ))                                                          
      CALL IOSXXX(W(1,2   ),W(1,4   ),W(1,6   ),GDRN1M ,AMP(2   ))         
     ...
     &     10  ))                                                          
      CALL IOSCXX(W(1,8   ),W(1,4   ),W(1,10  ),GDLN1P  ,AMP(4   ))        
      CALL HIOXXX(W(1,2   ),W(1,9   ),GDRN1M ,MSR     ,WSR     ,W(1,       
     &     11  ))                                                          
      CALL IOSCXX(W(1,8   ),W(1,4   ),W(1,11  ),GDRN1P  ,AMP(5   ))        
      do i=1,ngraphs
