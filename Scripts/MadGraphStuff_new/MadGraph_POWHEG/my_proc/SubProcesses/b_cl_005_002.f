...
C ----------
     ...
     &     5   ))                                                          
      CALL IOSXXX(W(1,2   ),W(1,4   ),W(1,5   ),GULN1M ,AMP(1   ))         
      CALL HIOXXX(W(1,3   ),W(1,1   ),GURN1P ,MCR     ,WCR     ,W(1,       
     &     6   ))                                                          
      CALL IOSXXX(W(1,2   ),W(1,4   ),W(1,6   ),GURN1M ,AMP(2   ))         
     ...
     &     10  ))                                                          
      CALL IOSCXX(W(1,8   ),W(1,4   ),W(1,10  ),GULN1P  ,AMP(4   ))        
      CALL HIOXXX(W(1,2   ),W(1,9   ),GURN1M ,MCR     ,WCR     ,W(1,       
     &     11  ))                                                          
      CALL IOSCXX(W(1,8   ),W(1,4   ),W(1,11  ),GURN1P  ,AMP(5   ))        
      do i=1,ngraphs
