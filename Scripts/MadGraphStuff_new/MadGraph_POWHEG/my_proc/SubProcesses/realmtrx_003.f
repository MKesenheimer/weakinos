...
C ----------
     ...
     &     9   ))                                                          
      ...
      CALL HIOXXX(W(1,1   ),W(1,4   ),GDLN2M ,MDL     ,WDL     ,W(1,       
     &     10  ))                                                          
      CALL FVOXXX(W(1,2   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL IOSXXX(W(1,3   ),W(1,11  ),W(1,10  ),GDLN1P ,AMP(3   ))         
      CALL HIOXXX(W(1,1   ),W(1,4   ),GDRN2M ,MDR     ,WDR     ,W(1,       
     &     12  ))                                                          
      CALL IOSXXX(W(1,3   ),W(1,11  ),W(1,12  ),GDRN1P ,AMP(4   ))         
     ...
     &     13  ))                                                          
      CALL FVIXXX(W(1,1   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,14  ),W(1,2   ),W(1,13  ),GZD ,AMP(7   ))            
      CALL IOVXXX(W(1,1   ),W(1,11  ),W(1,13  ),GZD ,AMP(8   ))            
      CALL IXXXXX(P(0,2   ),ZERO ,NHEL(2   ),+1*IC(2   ),W(1,15  ))        
      CALL OXXXXX(P(0,3   ),MN1 ,NHEL(3   ),+1*IC(3   ),W(1,16  ))         
      CALL HIOCXX(W(1,15  ),W(1,4   ),GDLN2P  ,MDL     ,WDL     ,W(1,      
     &     17  ))                                                          
      CALL IOSXXX(W(1,14  ),W(1,16  ),W(1,17  ),GDLN1M ,AMP(9   ))         
      CALL HIOCXX(W(1,15  ),W(1,4   ),GDRN2P  ,MDR     ,WDR     ,W(1,      
     &     18  ))                                                          
      CALL IOSXXX(W(1,14  ),W(1,16  ),W(1,18  ),GDRN1M ,AMP(10  ))         
      CALL HIOXXX(W(1,1   ),W(1,16  ),GDLN1M ,MDL     ,WDL     ,W(1,       
     &     19  ))                                                          
      CALL FSOCXX(W(1,4   ),W(1,19  ),GDLN2P  ,ZERO    ,ZERO    ,W(1,      
     &     20  ))                                                          
      CALL IOVCXX(W(1,15  ),W(1,20  ),W(1,5   ),GG  ,AMP(11  ))            
      CALL HIOXXX(W(1,1   ),W(1,16  ),GDRN1M ,MDR     ,WDR     ,W(1,       
     &     21  ))                                                          
      CALL FSOCXX(W(1,4   ),W(1,21  ),GDRN2P  ,ZERO    ,ZERO    ,W(1,      
     &     22  ))                                                          
      CALL IOVCXX(W(1,15  ),W(1,22  ),W(1,5   ),GG  ,AMP(12  ))            
      CALL VSSXXX(W(1,5   ),W(1,17  ),W(1,19  ),GC ,AMP(13  ))             
      CALL VSSXXX(W(1,5   ),W(1,18  ),W(1,21  ),GC ,AMP(14  ))             
