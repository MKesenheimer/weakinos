...
C ----------
     ...
     &     5   ))                                                          
      CALL IOSXXX(W(1,2   ),W(1,4   ),W(1,5   ),GULN2M ,AMP(1   ))         
      CALL HIOXXX(W(1,3   ),W(1,1   ),GURN1P ,MUR     ,WUR     ,W(1,       
     &     6   ))                                                          
      CALL IOSXXX(W(1,2   ),W(1,4   ),W(1,6   ),GURN2M ,AMP(2   ))         
      ...
      CALL HIOXXX(W(1,2   ),W(1,9   ),GULN1M ,MUL     ,WUL     ,W(1,       
     &     10  ))                                                          
      CALL IOSCXX(W(1,8   ),W(1,4   ),W(1,10  ),GULN2P  ,AMP(4   ))        
      CALL HIOXXX(W(1,2   ),W(1,9   ),GURN1M ,MUR     ,WUR     ,W(1,       
     &     11  ))                                                          
