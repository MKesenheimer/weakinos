...
C ----------
     ...
     &     5   ))                                                          
      CALL IOSXXX(W(1,1   ),W(1,4   ),W(1,5   ),GDLN2M ,AMP(1   ))         
      CALL HIOXXX(W(1,3   ),W(1,2   ),GDRN1P ,MSR     ,WSR     ,W(1,       
     &     6   ))                                                          
      CALL IOSXXX(W(1,1   ),W(1,4   ),W(1,6   ),GDRN2M ,AMP(2   ))         
      ...
      CALL HIOXXX(W(1,1   ),W(1,9   ),GDLN1M ,MSL     ,WSL     ,W(1,       
     &     10  ))                                                          
      CALL IOSCXX(W(1,8   ),W(1,4   ),W(1,10  ),GDLN2P  ,AMP(4   ))        
      CALL HIOXXX(W(1,1   ),W(1,9   ),GDRN1M ,MSR     ,WSR     ,W(1,       
     &     11  ))                                                          
