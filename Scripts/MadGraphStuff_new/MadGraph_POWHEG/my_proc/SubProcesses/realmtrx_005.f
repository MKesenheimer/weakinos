...
C ----------
     ...
     &     17  ))                                                          
      CALL FSOCXX(W(1,4   ),W(1,17  ),GULN1P  ,ZERO    ,ZERO    ,W(1,      
     &     18  ))                                                          
      CALL IOVCXX(W(1,15  ),W(1,18  ),W(1,5   ),GG  ,AMP(9   ))            
      CALL HIOXXX(W(1,2   ),W(1,16  ),GURN1M ,MUR     ,WUR     ,W(1,       
     &     19  ))                                                          
      CALL FSOCXX(W(1,4   ),W(1,19  ),GURN1P  ,ZERO    ,ZERO    ,W(1,      
     &     20  ))                                                          
