...
C ----------
     ...
     &     13  ))                                                          
      ...
      CALL IOVXXX(W(1,14  ),W(1,1   ),W(1,13  ),GZD ,AMP(8   ))            
