...
C ----------
     ...
     &     9   ))                                                          
      CALL FSOXXX(W(1,4   ),W(1,9   ),GDLN1M ,ZERO    ,ZERO    ,W(1,       
     &     10  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,10  ),W(1,5   ),GG ,AMP(3   ))             
      CALL HIOXXX(W(1,3   ),W(1,1   ),GDRN1P ,MSR     ,WSR     ,W(1,       
     &     11  ))                                                          
      CALL FSOXXX(W(1,4   ),W(1,11  ),GDRN1M ,ZERO    ,ZERO    ,W(1,       
     &     12  ))                                                          
     ...
     &     17  ))                                                          
      CALL FSOCXX(W(1,4   ),W(1,17  ),GDLN1P  ,ZERO    ,ZERO    ,W(1,      
     &     18  ))                                                          
      CALL IOVCXX(W(1,15  ),W(1,18  ),W(1,5   ),GG  ,AMP(9   ))            
      CALL HIOXXX(W(1,2   ),W(1,16  ),GDRN1M ,MSR     ,WSR     ,W(1,       
     &     19  ))                                                          
      CALL FSOCXX(W(1,4   ),W(1,19  ),GDRN1P  ,ZERO    ,ZERO    ,W(1,      
     &     20  ))                                                          
