...
C ----------
     ...
     &     9   ))                                                          
      ...
      CALL HIOXXX(W(1,1   ),W(1,4   ),GULN2M ,MUL     ,WUL     ,W(1,       
     &     10  ))                                                          
      CALL FVOXXX(W(1,2   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL IOSXXX(W(1,3   ),W(1,11  ),W(1,10  ),GULN1P ,AMP(3   ))         
      CALL HIOXXX(W(1,1   ),W(1,4   ),GURN2M ,MUR     ,WUR     ,W(1,       
     &     12  ))                                                          
      CALL IOSXXX(W(1,3   ),W(1,11  ),W(1,12  ),GURN1P ,AMP(4   ))         
     ...
     &     13  ))                                                          
      ...
      CALL IOVXXX(W(1,14  ),W(1,2   ),W(1,13  ),GZU ,AMP(7   ))            
      CALL IOVXXX(W(1,1   ),W(1,11  ),W(1,13  ),GZU ,AMP(8   ))            
      CALL IXXXXX(P(0,2   ),ZERO ,NHEL(2   ),+1*IC(2   ),W(1,15  ))        
      CALL OXXXXX(P(0,3   ),MN1 ,NHEL(3   ),+1*IC(3   ),W(1,16  ))         
      CALL HIOCXX(W(1,15  ),W(1,4   ),GULN2P  ,MUL     ,WUL     ,W(1,      
     &     17  ))                                                          
      CALL IOSXXX(W(1,14  ),W(1,16  ),W(1,17  ),GULN1M ,AMP(9   ))         
      CALL HIOCXX(W(1,15  ),W(1,4   ),GURN2P  ,MUR     ,WUR     ,W(1,      
     &     18  ))                                                          
      CALL IOSXXX(W(1,14  ),W(1,16  ),W(1,18  ),GURN1M ,AMP(10  ))         
      CALL HIOXXX(W(1,1   ),W(1,16  ),GULN1M ,MUL     ,WUL     ,W(1,       
     &     19  ))                                                          
      CALL FSOCXX(W(1,4   ),W(1,19  ),GULN2P  ,ZERO    ,ZERO    ,W(1,      
     &     20  ))                                                          
      CALL IOVCXX(W(1,15  ),W(1,20  ),W(1,5   ),GG  ,AMP(11  ))            
      CALL HIOXXX(W(1,1   ),W(1,16  ),GURN1M ,MUR     ,WUR     ,W(1,       
     &     21  ))                                                          
      CALL FSOCXX(W(1,4   ),W(1,21  ),GURN2P  ,ZERO    ,ZERO    ,W(1,      
     &     22  ))                                                          
