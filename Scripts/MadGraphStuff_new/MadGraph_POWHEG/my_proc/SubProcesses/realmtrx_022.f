...
C ----------
     ...
     &     8   ))                                                          
      ...
      CALL HIOXXX(W(1,3   ),W(1,5   ),GDLN1P ,MDL     ,WDL     ,W(1,       
     &     9   ))                                                          
      CALL VSSXXX(W(1,1   ),W(1,9   ),W(1,6   ),GC ,AMP(3   ))             
      CALL HIOXXX(W(1,3   ),W(1,5   ),GDRN1P ,MDR     ,WDR     ,W(1,       
     &     10  ))                                                          
      CALL VSSXXX(W(1,1   ),W(1,10  ),W(1,8   ),GC ,AMP(4   ))             
      CALL FVIXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL HIOXXX(W(1,11  ),W(1,4   ),GDLN2M ,MDL     ,WDL     ,W(1,       
     &     12  ))                                                          
      CALL IOSXXX(W(1,3   ),W(1,5   ),W(1,12  ),GDLN1P ,AMP(5   ))         
      CALL HIOXXX(W(1,11  ),W(1,4   ),GDRN2M ,MDR     ,WDR     ,W(1,       
     &     13  ))                                                          
