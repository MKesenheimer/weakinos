...
C ----------
     ...
     &     5   ))                                                          
      CALL IOSXXX(W(1,1   ),W(1,4   ),W(1,5   ),GULN2M ,AMP(1   ))         
      CALL HIOXXX(W(1,3   ),W(1,2   ),GURN1P ,MCR     ,WCR     ,W(1,       
     &     6   ))                                                          
      CALL IOSXXX(W(1,1   ),W(1,4   ),W(1,6   ),GURN2M ,AMP(2   ))         
      ...
      CALL OXXXXX(P(0,3   ),MN1 ,NHEL(3   ),+1*IC(3   ),W(1,9   ))         
      CALL HIOXXX(W(1,1   ),W(1,9   ),GULN1M ,MCL     ,WCL     ,W(1,       
     &     10  ))                                                          
      CALL IOSCXX(W(1,8   ),W(1,4   ),W(1,10  ),GULN2P  ,AMP(4   ))        
      CALL HIOXXX(W(1,1   ),W(1,9   ),GURN1M ,MCR     ,WCR     ,W(1,       
     &     11  ))                                                          
      CALL IOSCXX(W(1,8   ),W(1,4   ),W(1,11  ),GURN2P  ,AMP(5   ))        
      do i=1,ngraphs
