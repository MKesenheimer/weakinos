...
C ----------
     ...
     &     15  ))                                                          
      ...
      CALL HIOCXX(W(1,17  ),W(1,4   ),GULN1P  ,MCL     ,WCL     ,W(1,      
     &     19  ))                                                          
      CALL IOSXXX(W(1,16  ),W(1,18  ),W(1,19  ),GULN1M ,AMP(9   ))         
      CALL HIOCXX(W(1,17  ),W(1,4   ),GURN1P  ,MCR     ,WCR     ,W(1,      
     &     20  ))                                                          
     ...
     &     22  ))                                                          
      ...
      CALL HIOCXX(W(1,23  ),W(1,4   ),GULN1P  ,MCL     ,WCL     ,W(1,      
     &     24  ))                                                          
      CALL IOSXXX(W(1,5   ),W(1,18  ),W(1,24  ),GULN1M ,AMP(13  ))         
      CALL HIOCXX(W(1,23  ),W(1,4   ),GURN1P  ,MCR     ,WCR     ,W(1,      
     &     25  ))                                                          
