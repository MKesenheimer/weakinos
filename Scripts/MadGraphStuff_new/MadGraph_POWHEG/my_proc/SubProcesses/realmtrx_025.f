...
C ----------
      ...
      CALL HIOXXX(W(1,3   ),W(1,2   ),GULN1P ,MCL     ,WCL     ,W(1,       
     &     6   ))                                                          
      CALL FSOXXX(W(1,4   ),W(1,6   ),GULN2M ,ZERO    ,ZERO    ,W(1,       
     &     7   ))                                                          
      CALL IOVXXX(W(1,5   ),W(1,7   ),W(1,1   ),GG ,AMP(1   ))             
      CALL HIOXXX(W(1,3   ),W(1,2   ),GURN1P ,MCR     ,WCR     ,W(1,       
     &     8   ))                                                          
     ...
     &     15  ))                                                          
      ...
      CALL IOVXXX(W(1,16  ),W(1,2   ),W(1,15  ),GZU ,AMP(7   ))            
     ...
     &     21  ))                                                          
      CALL VSSXXX(W(1,1   ),W(1,19  ),W(1,21  ),GC ,AMP(11  ))             
      CALL HIOXXX(W(1,5   ),W(1,18  ),GURN1M ,MCR     ,WCR     ,W(1,       
     &     22  ))                                                          
      CALL VSSXXX(W(1,1   ),W(1,20  ),W(1,22  ),GC ,AMP(12  ))             
      CALL FVICXX(W(1,17  ),W(1,1   ),GG  ,ZERO    ,ZERO    ,W(1,23  ))    
