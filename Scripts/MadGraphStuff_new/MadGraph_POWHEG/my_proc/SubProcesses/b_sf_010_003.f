...
C ----------
     ...
     &     5   ))                                                          
      CALL IOSXXX(W(1,1   ),W(1,4   ),W(1,5   ),GB1N2M ,AMP(1   ))         
      CALL HIOXXX(W(1,3   ),W(1,2   ),GB2N1P ,MB2     ,WB2     ,W(1,       
     &     6   ))                                                          
      CALL IOSXXX(W(1,1   ),W(1,4   ),W(1,6   ),GB2N2M ,AMP(2   ))         
      CALL JIOXXX(W(1,1   ),W(1,2   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,7   ))    
      CALL IOVXXX(W(1,3   ),W(1,4   ),W(1,7   ),GZN12 ,AMP(3   ))          
      CALL HIOXXX(W(1,1   ),W(1,2   ),GH1BB ,MH1     ,WH1     ,W(1,        
     &     8   ))                                                          
      CALL IOSXXX(W(1,3   ),W(1,4   ),W(1,8   ),GH1N12 ,AMP(4   ))         
      CALL HIOXXX(W(1,1   ),W(1,2   ),GH2BB ,MH2     ,WH2     ,W(1,        
     &     9   ))                                                          
      CALL IOSXXX(W(1,3   ),W(1,4   ),W(1,9   ),GH2N12 ,AMP(5   ))         
      CALL HIOXXX(W(1,1   ),W(1,2   ),GH3BB ,MH3     ,WH3     ,W(1,        
     &     10  ))                                                          
      CALL IOSXXX(W(1,3   ),W(1,4   ),W(1,10  ),GH3N12 ,AMP(6   ))         
      CALL IXXXXX(P(0,2   ),BMASS ,NHEL(2   ),+1*IC(2   ),W(1,11  ))       
      CALL OXXXXX(P(0,3   ),MN1 ,NHEL(3   ),+1*IC(3   ),W(1,12  ))         
      CALL HIOXXX(W(1,1   ),W(1,12  ),GB1N1M ,MB1     ,WB1     ,W(1,       
     &     13  ))                                                          
      CALL IOSCXX(W(1,11  ),W(1,4   ),W(1,13  ),GB1N2P  ,AMP(7   ))        
      CALL HIOXXX(W(1,1   ),W(1,12  ),GB2N1M ,MB2     ,WB2     ,W(1,       
     &     14  ))                                                          
      CALL IOSCXX(W(1,11  ),W(1,4   ),W(1,14  ),GB2N2P  ,AMP(8   ))        
      do i=1,ngraphs
