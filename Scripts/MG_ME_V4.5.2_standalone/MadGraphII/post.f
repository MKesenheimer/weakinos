!WTARO!: to define a spin-3/2 line.
...
c
     ...
     $        .eq. -1) then
      ...
      write(4,*)
      write(4,10) '/Fphotonr' !WTARO
      write(4,10) '{{ Fx1 Fx2 Fx1 sub Fi mul Fnopoints div Fn'
      write(4,10) 'div Fxt Fi 90 mul Fnopoints div Frmod sin'
      write(4,10) 'mul Fttype mul 1 div add add Fy1 Fy2 Fy1 sub'
      write(4,10) 'Fi mul Fnopoints div Fn div Fyt Fi 90 mul'
      write(4,10) 'Fnopoints div Frmod sin mul Fttype mul 1 div'
      write(4,10) 'add add } Fstraight } def'
      write(4,*)
      write(4,10) '/Fphotond'
      write(4,10) '{{ Fx1 Fx2 Fx1 sub Fi mul Fnopoints div Fn'
