...
c      downtype quark
         ...
         elseif((iline(i).gt.25.and.iline(i).le.37).or.iline(i).eq.53) then
          chargeinfo(i)=1d0
         elseif(iline(i).gt.37.and. iline(i).ne.53) then
          chargeinfo(i)=0d0
         endif
        elseif(mod(iline(i),2).eq.0) then
...
c      downtype quark
         ...
         elseif((iline(i).gt.25.and.iline(i).le.37).or.iline(i).eq.54) then
          chargeinfo(i)=-1d0
         elseif(iline(i).gt.37.and.iline(i).ne.54) then
          chargeinfo(i)=0d0
         endif
        endif
...
c**************************************************************
     ...
     &           ')+p(NU,',info_ijk(i,1,5),')'
            ...
            write(ln,17)'CALL DIPOLEPDF(x(1),x(2),',
     &           info_p(5,inverse(iline_orig(1))),',',
     &           info_p(5,inverse(iline_orig(2))),',pdfwgt(2))'
            if (i.le.9) then
               write(ln,40)
...
c**************************************************************
     ...
     &              info_p(5,inverse(iline_orig(1))),',',
     &              info_p(5,inverse(iline_orig(2))),',pdfwgt(1))'
     ...
     &                 info_p(5,inverse(iline_orig(1))),',',
     &                 info_p(5,inverse(iline_orig(2))),',pdfwgt(3))'
               elseif(info_ijk(i,1,3).eq.2) then
