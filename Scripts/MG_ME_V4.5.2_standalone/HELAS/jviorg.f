...
c ----------------------------------------------------------------------
c
      subroutine jviorg(fi,fo,vc,gc,vmass,vwidth , jviorg1)
c
...
c
c input:
c       complex fi(6)          : flow-in  fermion
c       complex fo(6)          : flow-out goldstino
...
c
c output:
c       complex jviorg(6)      : vector current
c
c- by Yoshitaro Takaesu - 2010/12/05
c
      implicit none
      double complex fi(6),fo(6),vc(6),gc(2),jviorg1(6)
...
c
      ...
      jviorg1(3) = cZero
      jviorg1(4) = cZero
      jviorg1(5) = vc(5) +fo(5) - fi(5)
      jviorg1(6) = vc(6) +fo(6) - fi(6)
...
c         d = rOne/dcmplx( q2-vm2, max(vwidth*q2/vmass,rZero) )
         ...
         jviorg1(1) = d*(gc(1)*(flo(0,1)*fi(1) +flo(0,2)*fi(2))
     &              +gc(2)*(flo(0,3)*fi(3) +flo(0,4)*fi(4)))
         jviorg1(2) = d*(gc(1)*(flo(1,1)*fi(1) +flo(1,2)*fi(2))
     &              +gc(2)*(flo(1,3)*fi(3) +flo(1,4)*fi(4)))
         jviorg1(3) = d*(gc(1)*(flo(2,1)*fi(1) +flo(2,2)*fi(2))
     &              +gc(2)*(flo(2,3)*fi(3) +flo(2,4)*fi(4)))
         jviorg1(4) = d*(gc(1)*(flo(3,1)*fi(1) +flo(3,2)*fi(2))
     &              +gc(2)*(flo(3,3)*fi(3) +flo(3,4)*fi(4)))          
