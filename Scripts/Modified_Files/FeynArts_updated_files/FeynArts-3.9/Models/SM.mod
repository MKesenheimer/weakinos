...
NoQuarkMixing =
  ExcludeFieldPoints -> {
  	FieldPoint[_][-F[4, {1, ___}], F[4, {2, ___}]],
  	FieldPoint[_][-F[4, {2, ___}], F[4, {3, ___}]],
  	FieldPoint[_][-F[4, {1, ___}], F[4, {3, ___}]],

  	FieldPoint[_][-F[3, {1, ___}], F[3, {2, ___}]],
  	FieldPoint[_][-F[3, {2, ___}], F[3, {3, ___}]],
  	FieldPoint[_][-F[3, {1, ___}], F[3, {3, ___}]],
...
NoPhotonQuarkMixing =
  ExcludeFieldPoints -> {
    FieldPoint[_][-F[3, {1, ___}], F[3, {2, ___}], V[1]],
    FieldPoint[_][-F[3, {1, ___}], F[3, {3, ___}], V[1]],
    FieldPoint[_][-F[3, {2, ___}], F[3, {3, ___}], V[1]],
 	FieldPoint[_][-F[4, {1, ___}], F[4, {2, ___}], V[1]],
    FieldPoint[_][-F[4, {1, ___}], F[4, {3, ___}], V[1]],
    FieldPoint[_][-F[4, {2, ___}], F[4, {3, ___}], V[1]] }

NoPhotonFermionMixing =
  ExcludeFieldPoints -> {
  	FieldPoint[_][-F[1, {1, ___}], F[1, {2, ___}], V[1]],
    FieldPoint[_][-F[1, {1, ___}], F[1, {3, ___}], V[1]],
    FieldPoint[_][-F[1, {2, ___}], F[1, {3, ___}], V[1]],
 	FieldPoint[_][-F[2, {1, ___}], F[2, {2, ___}], V[1]],
    FieldPoint[_][-F[2, {1, ___}], F[2, {3, ___}], V[1]],
    FieldPoint[_][-F[2, {2, ___}], F[2, {3, ___}], V[1]],
    FieldPoint[_][-F[3, {1, ___}], F[3, {2, ___}], V[1]],
    FieldPoint[_][-F[3, {1, ___}], F[3, {3, ___}], V[1]],
    FieldPoint[_][-F[3, {2, ___}], F[3, {3, ___}], V[1]],
 	FieldPoint[_][-F[4, {1, ___}], F[4, {2, ___}], V[1]],
