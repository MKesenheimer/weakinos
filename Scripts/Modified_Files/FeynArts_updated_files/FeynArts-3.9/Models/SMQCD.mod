...
NoGluonQuarkMixing =
    ExcludeFieldPoints -> {
    FieldPoint[_][-F[3, {1, ___}], F[3, {2, ___}], V[5]],
    FieldPoint[_][-F[3, {1, ___}], F[3, {3, ___}], V[5]],
    FieldPoint[_][-F[3, {2, ___}], F[3, {3, ___}], V[5]],
    FieldPoint[_][-F[4, {1, ___}], F[4, {2, ___}], V[5]],
    FieldPoint[_][-F[4, {1, ___}], F[4, {3, ___}], V[5]],
    FieldPoint[_][-F[4, {2, ___}], F[4, {3, ___}], V[5]] }
