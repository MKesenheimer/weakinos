(*
	MSSMCT.mod
		...
		based on the Feynman rules of the MSSM by Arnd Kraft
                last modified 27 Apr 2015 by Matthias Kesenheimer
...
Apr 2015: Added SUSY restoring term for Yukawa couplings in MS_bar.
          quark-squark-gluino:
          gsy = gs*(1+AlfaS/(3*Pi)) == gs+dZgs1y
          (see: hep-ph/9308222)
          and for quark-squark-neutralino:
          ely = el*(1-AlfaS/(6*Pi)) == el+dZe1y.
          The values of gsy and ely must be set manually in the generated
          fortran code.
...
M$CouplingMatrices = {
 ...
 C[F[11, {n1}], -F[3, {j1, o1}], S[13, {s2, j2, o2}]] == 
  {{((I/3)*ELY*IndexDelta[j1, j2]*IndexDelta[o1, o2]*
    ...
    ((I/6)*ELY*IndexDelta[j1, j2]*IndexDelta[o1, o2]*
 ...
 C[F[15, {g1}], -F[3, {j1, o1}], S[13, {s2, j2, o2}]] == 
  {{I*Sqrt[2]*GSY*Conjugate[SqrtEGl]*Conjugate[USf[3, j1][s2, 2]]*
     IndexDelta[j1, j2]*SUNT[g1, o1, o2], 
    (I*GSY*Conjugate[SqrtEGl]*(Conjugate[USf[3, j1][s2, 2]]*
   ...
   {(-I)*Sqrt[2]*GSY*SqrtEGl*Conjugate[USf[3, j1][s2, 1]]*IndexDelta[j1, j2]*
     SUNT[g1, o1, o2], ((-I)*GSY*SqrtEGl*(Conjugate[USf[3, j1][s2, 1]]*
        (dZGlR1 + 2*dZgs1 + dZbarfL1[3, j1, j1]) + 
       Conjugate[USf[3, j1][1, 1]]*dZSf1[1, s2, 3, j2] + 
       Conjugate[USf[3, j1][2, 1]]*dZSf1[2, s2, 3, j2])*IndexDelta[j1, j2]*
      SUNT[g1, o1, o2])/Sqrt[2]}}, 
 C[F[15, {g1}], -F[4, {j1, o1}], S[14, {s2, j2, o2}]] == 
  {{I*Sqrt[2]*GSY*Conjugate[SqrtEGl]*Conjugate[USf[4, j1][s2, 2]]*
     IndexDelta[j1, j2]*SUNT[g1, o1, o2], 
    (I*GSY*Conjugate[SqrtEGl]*(Conjugate[USf[4, j1][s2, 2]]*
      ...
      SUNT[g1, o1, o2])/Sqrt[2]}, 
   {(-I)*Sqrt[2]*GSY*SqrtEGl*Conjugate[USf[4, j1][s2, 1]]*IndexDelta[j1, j2]*
     SUNT[g1, o1, o2], ((-I)*GSY*SqrtEGl*(Conjugate[USf[4, j1][s2, 1]]*
        (dZGlR1 + 2*dZgs1 + dZbarfL1[4, j1, j1]) + 
       Conjugate[USf[4, j1][1, 1]]*dZSf1[1, s2, 4, j2] + 
       Conjugate[USf[4, j1][2, 1]]*dZSf1[2, s2, 4, j2])*IndexDelta[j1, j2]*
      SUNT[g1, o1, o2])/Sqrt[2]}}, 
 C[F[15, {g1}], F[3, {j1, o1}], -S[13, {s2, j2, o2}]] == 
  {{(-I)*Sqrt[2]*GSY*Conjugate[SqrtEGl]*IndexDelta[j1, j2]*SUNT[g1, o2, o1]*
     USf[3, j1][s2, 1], ((-I)*GSY*Conjugate[SqrtEGl]*IndexDelta[j1, j2]*
      SUNT[g1, o2, o1]*(dZbarSf1[1, s2, 3, j2]*USf[3, j1][1, 1] + 
       dZbarSf1[2, s2, 3, j2]*USf[3, j1][2, 1] + 
       (dZGlL1 + 2*dZgs1 + dZfL1[3, j1, j1])*USf[3, j1][s2, 1]))/Sqrt[2]}, 
   {I*Sqrt[2]*GSY*SqrtEGl*IndexDelta[j1, j2]*SUNT[g1, o2, o1]*
     USf[3, j1][s2, 2], (I*GSY*SqrtEGl*IndexDelta[j1, j2]*SUNT[g1, o2, o1]*
      (dZbarSf1[1, s2, 3, j2]*USf[3, j1][1, 2] + dZbarSf1[2, s2, 3, j2]*
        USf[3, j1][2, 2] + (dZGlR1 + 2*dZgs1 + dZfR1[3, j1, j1])*
        USf[3, j1][s2, 2]))/Sqrt[2]}}, 
 C[F[15, {g1}], F[4, {j1, o1}], -S[14, {s2, j2, o2}]] == 
  {{(-I)*Sqrt[2]*GSY*Conjugate[SqrtEGl]*IndexDelta[j1, j2]*SUNT[g1, o2, o1]*
     USf[4, j1][s2, 1], ((-I)*GSY*Conjugate[SqrtEGl]*IndexDelta[j1, j2]*
      SUNT[g1, o2, o1]*(dZbarSf1[1, s2, 4, j2]*USf[4, j1][1, 1] + 
       dZbarSf1[2, s2, 4, j2]*USf[4, j1][2, 1] + 
       (dZGlL1 + 2*dZgs1 + dZfL1[4, j1, j1])*USf[4, j1][s2, 1]))/Sqrt[2]}, 
   {I*Sqrt[2]*GSY*SqrtEGl*IndexDelta[j1, j2]*SUNT[g1, o2, o1]*
     USf[4, j1][s2, 2], (I*GSY*SqrtEGl*IndexDelta[j1, j2]*SUNT[g1, o2, o1]*
