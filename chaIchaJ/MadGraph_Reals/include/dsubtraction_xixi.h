...
#define DSUBTRACTION_H
      ...
      integer CHAN                           ! distuinguish between u-, t-channels, left and right

#if defined(DR_II) || defined(DSUB)
...
#ifndef _EXTFUNCT_               
      double precision MATRIX_DG_XIXID_RES   ! gives back matrix element squared 
      external MATRIX_DG_XIXID_RES           ! from resonant diagrams in  
      double precision MATRIX_DXG_XIXIDX_RES ! dependence on CHAN:
      external MATRIX_DXG_XIXIDX_RES         ! u channel diagrams (s35 = msq^2), CHAN=0: left, CHAN=1: right
      double precision MATRIX_GD_XIXID_RES   ! t channel diagrams (s45 = msq^2), CHAN=2: left, CHAN=3: right
      external MATRIX_GD_XIXID_RES
      double precision MATRIX_GDX_XIXIDX_RES 
      external MATRIX_GDX_XIXIDX_RES
      double precision MATRIX_GU_XIXIU_RES
      external MATRIX_GU_XIXIU_RES
      double precision MATRIX_GUX_XIXIUX_RES
      external MATRIX_GUX_XIXIUX_RES
      double precision MATRIX_UG_XIXIU_RES
      external MATRIX_UG_XIXIU_RES
      double precision MATRIX_UXG_XIXIUX_RES
      external MATRIX_UXG_XIXIUX_RES
#endif
