...
#ifndef _EXTFUNCT_               
      double precision MATRIX_DG_XIXJD_RES   ! gives back matrix element squared 
      external MATRIX_DG_XIXJD_RES           ! from resonant diagrams in  
      double precision MATRIX_DXG_XIXJDX_RES ! dependence on CHAN:
      external MATRIX_DXG_XIXJDX_RES         ! u channel diagrams (s35 = msq^2), CHAN=0: left, CHAN=1: right
      double precision MATRIX_GD_XIXJD_RES   ! t channel diagrams (s45 = msq^2), CHAN=2: left, CHAN=3: right
      external MATRIX_GD_XIXJD_RES
      double precision MATRIX_GDX_XIXJDX_RES 
      external MATRIX_GDX_XIXJDX_RES
      double precision MATRIX_GU_XIXJU_RES
      external MATRIX_GU_XIXJU_RES
      double precision MATRIX_GUX_XIXJUX_RES
      external MATRIX_GUX_XIXJUX_RES
      double precision MATRIX_UG_XIXJU_RES
      external MATRIX_UG_XIXJU_RES
      double precision MATRIX_UXG_XIXJUX_RES
      external MATRIX_UXG_XIXJUX_RES
#endif
