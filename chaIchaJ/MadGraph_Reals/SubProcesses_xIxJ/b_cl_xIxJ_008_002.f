      SUBROUTINE SB_CL_xIxJ_008_002(P1,ANS)
C  
...
C  
C FOR PROCESS : s s~ -> xi+ xj- g  
C  
C BORN AMPLITUDE IS s s~ -> xi+ xj-  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C          write(*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_CL_xIxJ_008_002(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_CL_xIxJ_008_002(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     5))                                                          
      ...
      CALL JIOXXX(W(1,1),W(1,2),GZD,ZMASS,ZWIDTH,W(1,6))    
      CALL IOVXXX(W(1,3),W(1,4),W(1,6),GZXIJ,AMP(2))          
      do i=1,ngraphs
      ...
      JAMP(   1) = -AMP(   1)+AMP(   2)
      B_CL_xIxJ_008_002 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          B_CL_xIxJ_008_002 =B_CL_xIxJ_008_002
