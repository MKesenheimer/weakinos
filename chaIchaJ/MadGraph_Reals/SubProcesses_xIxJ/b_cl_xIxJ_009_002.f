      SUBROUTINE SB_CL_xIxJ_009_002(P1,ANS)
C  
...
C  
C FOR PROCESS : b~ b -> xi+ xj- g  
C  
C BORN AMPLITUDE IS b~ b -> xi+ xj-  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C          write(*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_CL_xIxJ_009_002(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_CL_xIxJ_009_002(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     5))                                                          
      CALL IOSXXX(W(1,2),W(1,4),W(1,5),GT1XJM,AMP(1))         
      CALL HIOXXX(W(1,3),W(1,1),GT2XIP,MTR,WT2,W(1,       
     &     6))                                                          
      CALL IOSXXX(W(1,2),W(1,4),W(1,6),GT2XJM,AMP(2))         
      CALL JIOXXX(W(1,2),W(1,1),GZD,ZMASS,ZWIDTH,W(1,7))    
      CALL IOVXXX(W(1,3),W(1,4),W(1,7),GZXIJ,AMP(3))          
      CALL HIOXXX(W(1,2),W(1,1),GH1BB,MH1,WH1,W(1,        
     &     8))                                                          
      CALL IOSXXX(W(1,3),W(1,4),W(1,8),GH1XIJ,AMP(4))         
      CALL HIOXXX(W(1,2),W(1,1),GH2BB,MH2,WH2,W(1,        
     &     9))                                                          
      CALL IOSXXX(W(1,3),W(1,4),W(1,9),GH2XIJ,AMP(5))         
      CALL HIOXXX(W(1,2),W(1,1),GH3BB,MH3,WH3,W(1,        
     &     10))                                                          
      CALL IOSXXX(W(1,3),W(1,4),W(1,10),GH3XIJ,AMP(6))         
      do i=1,ngraphs
     ...
     &             -AMP(   6)
      B_CL_xIxJ_009_002 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          B_CL_xIxJ_009_002 =B_CL_xIxJ_009_002
