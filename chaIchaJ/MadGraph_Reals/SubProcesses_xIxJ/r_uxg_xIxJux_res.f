      SUBROUTINE SMATRIX_UXG_XIXJUX_RES(P1,CHAN,ANS)
C  
...
C  
      ...
      common/to_amps_uxg_xixj_res/  amp2,       jamp2
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UXG_XIXJUX_RES(P,NHEL(1,IHEL),JC(1),CHAN)
