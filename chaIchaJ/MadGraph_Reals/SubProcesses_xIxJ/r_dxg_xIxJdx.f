      SUBROUTINE SMATRIX_DXG_XIXJDX(P1,ANS)
C  
...
C  
C FOR PROCESS : d~ g -> xi+ xj- d~  
C  
C Crossing   1 is d~ g -> xi+ xj- d~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_dxg_xixj/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_DXG_XIXJDX(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_DXG_XIXJDX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
c delete resonant diagrams (diagram removal type I)
      ...
      MATRIX_DXG_XIXJDX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_DXG_XIXJDX =MATRIX_DXG_XIXJDX
...
c (diagram removal type II)
     ...
     &                      +ZTEMP*DCONJG(JAMPR(I))/DENOM(I)   
      ...
      MATRIX_DXG_XIXJDX = MATRIX_DXG_XIXJDX - MATRIX_RESONANT
#endif
...
c back in subroutine setosresreal
      ...
      MATRIX_DXG_XIXJDX = MATRIX_DXG_XIXJDX
     &                - MATRIX_DXG_XIXJDX_RES(p,NHEL,IC,"ul45")
#endif
...
c the interference term and the off-shell contributions
      ...
      if( (S.ge.(MUL+MXI)**2) .and. (MUL.ge.MXJ)) then
        ...
        COUNTER45L = RATIO45L*MATRIX_DXG_XIXJDX_RES(p_OS,NHEL,IC,"ul45")
      endif
      
      MATRIX_DXG_XIXJDX = MATRIX_DXG_XIXJDX - COUNTER45L
#endif
