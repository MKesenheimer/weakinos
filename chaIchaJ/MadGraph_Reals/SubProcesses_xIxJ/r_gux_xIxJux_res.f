      SUBROUTINE SMATRIX_GUX_XIXJUX_RES(P1,CHAN,ANS)
C  
...
C  
      ...
      common/to_amps_gux_xixj_res/  amp2,       jamp2
...
C ----------
      ...
      REAL*8 FUNCTION MATRIX_GUX_XIXJUX_RES(P,NHEL,IC,CHAN)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      MATRIX_GUX_XIXJUX_RES = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_GUX_XIXJUX_RES =MATRIX_GUX_XIXJUX_RES
