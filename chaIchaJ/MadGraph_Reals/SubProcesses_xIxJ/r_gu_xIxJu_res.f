      SUBROUTINE SMATRIX_GU_XIXJU_RES(P1,CHAN,ANS)
C  
...
C  
      ...
      common/to_amps_gu_xixj_res/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_GU_XIXJU_RES(P,NHEL(1,IHEL),JC(1),CHAN)
      ...
      REAL*8 FUNCTION MATRIX_GU_XIXJU_RES(P,NHEL,IC,CHAN)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVCXX(W(1,10),W(1,12),W(1,1),GG,AMP(3))          
      ! diagram 4 <- resonant
      CALL HVSXXX(W(1,1),W(1,11),-GC,MDL,WDLR,W(1,13))    
      ...
      MATRIX_GU_XIXJU_RES = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_GU_XIXJU_RES =MATRIX_GU_XIXJU_RES
