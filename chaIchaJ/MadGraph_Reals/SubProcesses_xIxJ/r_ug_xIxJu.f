      SUBROUTINE SMATRIX_UG_XIXJU(P1,ANS)
C  
...
C  
      ...
      common/to_amps_ug_xixj/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UG_XIXJU(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_UG_XIXJU(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVCXX(W(1,10),W(1,12),W(1,2),GG,AMP(3))          
      ! diagram 4 <- resonant
      CALL HVSXXX(W(1,2),W(1,11),-GC,MDL,WDLR,W(1,13))    
      CALL IOSCXX(W(1,10),W(1,4),W(1,13),GDLXJP,AMP(4))        
      ! diagram 5 <- resonant
      CALL HIOXXX(W(1,8),W(1,9),GDLXIM,MDL,WDLR,W(1,14))                                                          
      CALL IOSCXX(W(1,10),W(1,4),W(1,14),GDLXJP,AMP(5))    
      
c delete resonant diagrams (diagram removal type I)
#ifdef DR_I
      AMP(4)  = 0 ! diagram 4,  s45, L
      AMP(5)  = 0 ! diagram 5,  s45, L
#endif
      
      JAMP(   1) = +AMP(   1)+AMP(   2)-AMP(   3)-AMP(   4)-AMP(   5)
      MATRIX_UG_XIXJU = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_UG_XIXJU =MATRIX_UG_XIXJU
...
c (diagram removal type II)
     ...
     &                      +ZTEMP*DCONJG(JAMPR(I))/DENOM(I)   
      ...
      MATRIX_UG_XIXJU = MATRIX_UG_XIXJU - MATRIX_RESONANT
#endif
...
c back in subroutine setosresreal
      ...
      MATRIX_UG_XIXJU = MATRIX_UG_XIXJU
     &                - MATRIX_UG_XIXJU_RES(p,NHEL,IC,"dl45")
#endif
...
c the interference term and the off-shell contributions
      ...
      if( (S.ge.(MDL+MXI)**2) .and. (MDL.ge.MXJ)) then
        ...
        COUNTER45L = RATIO45L*MATRIX_UG_XIXJU_RES(p_OS,NHEL,IC,"dl45")
      endif
      
      MATRIX_UG_XIXJU = MATRIX_UG_XIXJU - COUNTER45L
