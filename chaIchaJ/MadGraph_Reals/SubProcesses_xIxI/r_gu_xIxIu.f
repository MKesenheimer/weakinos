      SUBROUTINE SMATRIX_GU_XIXIU(P1,ANS)
C  
...
C  
C FOR PROCESS : g u -> xI+ xI- u  
C  
C Crossing   1 is g u -> xI+ xI- u  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_gu_xixi/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_GU_XIXIU(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_GU_XIXIU(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      ! diagram 6 <- resonant
      CALL HVSXXX(W(1,1),W(1,12),-GC,MDL,WDLR,W(1,14))    
...
c the interference term and the off-shell contributions
      ...
      if( (S.ge.(MDL+MXI)**2) .and. (MDL.ge.MXI)) then
        ...
        COUNTER45L = RATIO45L*MATRIX_GU_XIXIU_RES(p_OS,NHEL,IC,"dl45")
      endif
