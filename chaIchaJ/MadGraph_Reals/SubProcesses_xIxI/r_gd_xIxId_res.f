      SUBROUTINE SMATRIX_GD_XIXID_RES(P1,CHAN,ANS)
C  
...
C  
      ...
      common/to_amps_gd_xixi_res/  amp2,       jamp2
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_GD_XIXID_RES(P,NHEL(1,IHEL),JC(1),CHAN)
