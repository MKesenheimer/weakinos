      SUBROUTINE SMATRIX_DXG_XIXIDX(P1,ANS)
C  
...
C  
      ...
      common/to_amps_dxg_xixi/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_DXG_XIXIDX(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_DXG_XIXIDX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
c delete resonant diagrams (diagram removal type I)
     ...
     &             -AMP(   6)-AMP(   7)
      MATRIX_DXG_XIXIDX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_DXG_XIXIDX =MATRIX_DXG_XIXIDX
...
c (diagram removal type II)
     ...
     &                      +ZTEMP*DCONJG(JAMPR(I))/DENOM(I)   
      ...
      MATRIX_DXG_XIXIDX = MATRIX_DXG_XIXIDX - MATRIX_RESONANT
#endif
...
c back in subroutine setosresreal
      ...
      MATRIX_DXG_XIXIDX = MATRIX_DXG_XIXIDX
     &                  - MATRIX_DXG_XIXIDX_RES(p,NHEL,IC,"ul45")
#endif
...
c the interference term and the off-shell contributions
      ...
      if( (S.ge.(MUL+MXI)**2) .and. (MUL.ge.MXI)) then
        ...
        COUNTER45L = RATIO45L*MATRIX_DXG_XIXIDX_RES(p_OS,NHEL,IC,"ul45")
      endif
      
      MATRIX_DXG_XIXIDX = MATRIX_DXG_XIXIDX - COUNTER45L
#endif
