      SUBROUTINE SB_CL_xIxI_010_002(P1,ANS)
C  
...
C          write(*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_CL_xIxI_010_002(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_CL_xIxI_010_002(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,3),W(1,2),GT1XIP,MTL,WT1,W(1,       
     &     5))                                                          
      CALL IOSXXX(W(1,1),W(1,4),W(1,5),GT1XIM,AMP(1))         
      CALL HIOXXX(W(1,3),W(1,2),GT2XIP,MTR,WT2,W(1,       
     &     6))                                                          
      CALL IOSXXX(W(1,1),W(1,4),W(1,6),GT2XIM,AMP(2))         
      CALL JIOXXX(W(1,1),W(1,2),GAD,ZERO,AWIDTH,W(1,7))    
     ...
     &             +AMP(   6)+AMP(   7)
      B_CL_xIxI_010_002 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          B_CL_xIxI_010_002 =B_CL_xIxI_010_002
