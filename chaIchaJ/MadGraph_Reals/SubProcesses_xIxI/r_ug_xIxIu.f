      SUBROUTINE SMATRIX_UG_XIXIU(P1,ANS)
C  
...
C  
      ...
      common/to_amps_ug_xixi/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UG_XIXIU(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_UG_XIXIU(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
#ifdef DR_I
      AMP(6)  = 0 ! diagram 6,  s45, L, XI-
      AMP(7)  = 0 ! diagram 7,  s45, L, XI-
#endif
      
      JAMP(   1) = +AMP(   1)+AMP(   2)+AMP(   3)+AMP(   4)-AMP(   5)
     &             -AMP(   6)-AMP(   7)
      MATRIX_UG_XIXIU = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_UG_XIXIU =MATRIX_UG_XIXIU
...
c (diagram removal type II)
     ...
     &                      +ZTEMP*DCONJG(JAMPR(I))/DENOM(I)   
      ...
      MATRIX_UG_XIXIU = MATRIX_UG_XIXIU - MATRIX_RESONANT
#endif
...
c back in subroutine setosresreal
      ...
      MATRIX_UG_XIXIU = MATRIX_UG_XIXIU
     &                  - MATRIX_UG_XIXIU_RES(p,NHEL,IC,"dl45")
#endif
...
c the interference term and the off-shell contributions
      ...
      if( (S.ge.(MDL+MXI)**2) .and. (MDL.ge.MXI)) then
        ...
        COUNTER45L = RATIO45L*MATRIX_UG_XIXIU_RES(p_OS,NHEL,IC,"dl45")
      endif
      
      MATRIX_UG_XIXIU = MATRIX_UG_XIXIU - COUNTER45L
