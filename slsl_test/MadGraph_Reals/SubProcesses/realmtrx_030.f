...
C ----------
     ...
     &     10  ))                                                          
      ...
      CALL IOVXXX(W(1,11  ),W(1,5   ),W(1,6   ),GAD ,AMP(5   ))            
      CALL IOVXXX(W(1,11  ),W(1,5   ),W(1,8   ),GZD ,AMP(6   ))            
      CALL IOSXXX(W(1,11  ),W(1,5   ),W(1,9   ),GH1BB ,AMP(7   ))          
      CALL IOSXXX(W(1,11  ),W(1,5   ),W(1,10  ),GH2BB ,AMP(8   ))          
