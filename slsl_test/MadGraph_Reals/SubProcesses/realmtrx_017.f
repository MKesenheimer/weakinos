...
C ----------
     ...
     &     9   ))                                                          
      CALL IOSXXX(W(1,2   ),W(1,7   ),W(1,9   ),GH1BB ,AMP(3   ))          
      CALL HSSXXX(W(1,4   ),W(1,3   ),GH2ERER ,MH2     ,WH2     ,W(1,      
     &     10  ))                                                          
      CALL IOSXXX(W(1,2   ),W(1,7   ),W(1,10  ),GH2BB ,AMP(4   ))          
      CALL FVIXXX(W(1,2   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,11  ))     
      CALL IOVXXX(W(1,11  ),W(1,1   ),W(1,6   ),GAD ,AMP(5   ))            
      CALL IOVXXX(W(1,11  ),W(1,1   ),W(1,8   ),GZD ,AMP(6   ))            
      CALL IOSXXX(W(1,11  ),W(1,1   ),W(1,9   ),GH1BB ,AMP(7   ))          
      CALL IOSXXX(W(1,11  ),W(1,1   ),W(1,10  ),GH2BB ,AMP(8   ))          
