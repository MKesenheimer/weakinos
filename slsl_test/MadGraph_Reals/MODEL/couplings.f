...
c
     ...
     &        bw,uu,vv,m_t,m_b,m_l,param_name)
            ...
            ! file. But be warned: When calling setpara for the
...
! Kesenheimer: overwrite here already initialized parameters to gain better accordance to Formcalc amplitudes
...
! kesenheimer: set Higgs couplings manually to zero
#ifndef MAD_HIGGS
      gh1bb = 0 
      gh2bb = 0
      gh3bb = 0
...
c -- yl given at the scale Q                                     --- c
      if(gw.ne.0)then
        ...
        ! kesenheimer: set bottom mass equals to bmass (see line 465)
