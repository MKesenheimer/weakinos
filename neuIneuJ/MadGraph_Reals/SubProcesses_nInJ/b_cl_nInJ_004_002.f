      SUBROUTINE SB_CL_nInJ_004_002(P1,ANS)
C  
...
C          write(*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_CL_nInJ_004_002(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_CL_nInJ_004_002(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,3),W(1,2),GULNIP,MUL,WUL,W(1,       
     &     5))                                                          
      CALL IOSXXX(W(1,1),W(1,4),W(1,5),GULNJM,AMP(1))         
      CALL HIOXXX(W(1,3),W(1,2),GURNIP,MUR,WUR,W(1,       
     &     6))                                                          
      ...
      CALL HIOXXX(W(1,1),W(1,9),GULNIM,MUL,WUL,W(1,       
     &     10))                                                          
      CALL IOSCXX(W(1,8),W(1,4),W(1,10),GULNJP,AMP(4))        
      CALL HIOXXX(W(1,1),W(1,9),GURNIM,MUR,WUR,W(1,       
     &     11))                                                          
      ...
      B_CL_nInJ_004_002 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          B_CL_nInJ_004_002 =B_CL_nInJ_004_002
