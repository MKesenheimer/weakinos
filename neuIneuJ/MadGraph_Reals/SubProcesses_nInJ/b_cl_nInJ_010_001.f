      SUBROUTINE SB_CL_nInJ_010_001(P1,ANS)
C  
...
C  
C FOR PROCESS : b b~ -> ni nj g  
C  
C BORN AMPLITUDE IS b b~ -> ni nj  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C          write(*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_CL_nInJ_010_001(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_CL_nInJ_010_001(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IXXXXX(P(0,3),MNI,NHEL(3),-1*IC(3),W(1,3))         
      CALL OXXXXX(P(0,4),MNJ,NHEL(4),+1*IC(4),W(1,4))         
      CALL HIOXXX(W(1,3),W(1,2),GB1NIP,MBL,WB1,W(1,       
     &     5))                                                          
      CALL IOSXXX(W(1,1),W(1,4),W(1,5),GB1NJM,AMP(1))         
      CALL HIOXXX(W(1,3),W(1,2),GB2NIP,MBR,WB2,W(1,       
     &     6))                                                          
      CALL IOSXXX(W(1,1),W(1,4),W(1,6),GB2NJM,AMP(2))         
      CALL JIOXXX(W(1,1),W(1,2),GZD,ZMASS,ZWIDTH,W(1,7))    
      CALL IOVXXX(W(1,3),W(1,4),W(1,7),GZNIJ,AMP(3))          
      CALL HIOXXX(W(1,1),W(1,2),GH1BB,MH1,WH1,W(1,        
     &     8))                                                          
      CALL IOSXXX(W(1,3),W(1,4),W(1,8),GH1NIJ,AMP(4))         
      CALL HIOXXX(W(1,1),W(1,2),GH2BB,MH2,WH2,W(1,        
     &     9))                                                          
      CALL IOSXXX(W(1,3),W(1,4),W(1,9),GH2NIJ,AMP(5))         
      CALL HIOXXX(W(1,1),W(1,2),GH3BB,MH3,WH3,W(1,        
     &     10))                                                          
      CALL IOSXXX(W(1,3),W(1,4),W(1,10),GH3NIJ,AMP(6))         
      CALL IXXXXX(P(0,2),BMASS,NHEL(2),+1*IC(2),W(1,11))       
      CALL OXXXXX(P(0,3),MNI,NHEL(3),+1*IC(3),W(1,12))         
      CALL HIOXXX(W(1,1),W(1,12),GB1NIM,MBL,WB1,W(1,       
     &     13))                                                          
      CALL IOSCXX(W(1,11),W(1,4),W(1,13),GB1NJP,AMP(7))        
      CALL HIOXXX(W(1,1),W(1,12),GB2NIM,MBR,WB2,W(1,       
     &     14))                                                          
      CALL IOSCXX(W(1,11),W(1,4),W(1,14),GB2NJP,AMP(8))        
      do i=1,ngraphs
     ...
     &             +AMP(   6)-AMP(   7)-AMP(   8)
      B_CL_nInJ_010_001 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          B_CL_nInJ_010_001 =B_CL_nInJ_010_001
