...
c the interference term and the off-shell contributions
      ...
      if( (S.ge.(MDL+dabs(MNJ))**2) .and. (MDL.ge.dabs(MNI))) then
        ...
        COUNTER35L = RATIO35L*MATRIX_GD_NINJD_RES(p_OS,NHEL,IC,"dl35") ! generate the counter term
      endif
      ...
      if( (S.ge.(MDR+dabs(MNJ))**2) .and. (MDR.ge.dabs(MNI))) then
        ...
        COUNTER35R = RATIO35R*MATRIX_GD_NINJD_RES(p_OS,NHEL,IC,"dr35")
      endif
      ...
      if( (S.ge.(MDL+dabs(MNI))**2) .and. (MDL.ge.dabs(MNJ))) then
        ...
        COUNTER45L = RATIO45L*MATRIX_GD_NINJD_RES(p_OS,NHEL,IC,"dl45")
      endif
      ...
      if( (S.ge.(MDR+dabs(MNI))**2) .and. (MDR.ge.dabs(MNJ))) then
        ...
        COUNTER45R = RATIO45R*MATRIX_GD_NINJD_RES(p_OS,NHEL,IC,"dr45")
      endif
