      SUBROUTINE SMATRIX_UXU_NINJG(P1,ANS)
C  
...
C ----------
      ...
      CALL HIOXXX(W(1,2),W(1,3),GULNIM,MUL,WUL,W(1,       
     &     6))                                                          
      CALL FSIXXX(W(1,4),W(1,6),GULNJP,ZERO,ZERO,W(1,       
     &     7))                                                          
      CALL IOVXXX(W(1,7),W(1,1),W(1,5),GG,AMP(1))             
      CALL HIOXXX(W(1,2),W(1,3),GURNIM,MUR,WUR,W(1,       
     &     8))                                                          
      CALL FSIXXX(W(1,4),W(1,8),GURNJP,ZERO,ZERO,W(1,       
     &     9))                                                          
      CALL IOVXXX(W(1,9),W(1,1),W(1,5),GG,AMP(2))             
      CALL HIOXXX(W(1,4),W(1,1),GULNJP,MUL,WUL,W(1,       
     &     10))                                                          
      CALL FVIXXX(W(1,2),W(1,5),GG,ZERO,ZERO,W(1,11))     
      CALL IOSXXX(W(1,11),W(1,3),W(1,10),GULNIM,AMP(3))         
      CALL HIOXXX(W(1,4),W(1,1),GURNJP,MUR,WUR,W(1,       
     &     12))                                                          
      ...
      CALL JIOCXX(W(1,4),W(1,3),GZNIJ,ZMASS,ZWIDTH,W(1,       
     &     13))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,16),GULNJM,MUL,WUL,W(1,       
     &     17))                                                          
      CALL IOSXXX(W(1,15),W(1,14),W(1,17),GULNIP,AMP(9))         
      CALL HIOXXX(W(1,2),W(1,16),GURNJM,MUR,WUR,W(1,       
     &     18))                                                          
      CALL IOSXXX(W(1,15),W(1,14),W(1,18),GURNIP,AMP(10))         
      CALL HIOXXX(W(1,15),W(1,1),GULNIP,MUL,WUL,W(1,       
     &     19))                                                          
      CALL FSOXXX(W(1,16),W(1,19),GULNJM,ZERO,ZERO,W(1,       
     &     20))                                                          
      CALL IOVXXX(W(1,2),W(1,20),W(1,5),GG,AMP(11))             
      CALL HIOXXX(W(1,15),W(1,1),GURNIP,MUR,WUR,W(1,       
     &     21))                                                          
      CALL FSOXXX(W(1,16),W(1,21),GURNJM,ZERO,ZERO,W(1,       
     &     22))                                                          
