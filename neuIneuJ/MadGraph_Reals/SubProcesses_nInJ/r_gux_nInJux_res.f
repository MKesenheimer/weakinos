      SUBROUTINE SMATRIX_GUX_NINJUX_RES(P1,CHAN,ANS)
C  
...
C  
      ...
      common/to_amps_gux_res/  amp2,       jamp2
        ...
        ANS(IPROC) = 0D0
            DO IHEL=1,NCOMB
               IF(GOODHEL1(IHEL,IPROC) .OR. NTRY1 .LT. 2) THEN
                   T=MATRIX_GUX_NINJUX_RES(P,NHEL(1,IHEL),JC(1),CHAN)
