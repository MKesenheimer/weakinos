      SUBROUTINE SB_SF_nInJ_003_004(P1,ANS)
C  
...
C  
C FOR PROCESS : u~ u -> ni nj g  
C  
C BORN AMPLITUDE IS u~ u -> ni nj  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C          write(*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_nInJ_003_004(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_nInJ_003_004(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,3),W(1,1),GULNIP,MUL,WUL,W(1,       
     &     5))                                                          
      CALL IOSXXX(W(1,2),W(1,4),W(1,5),GULNJM,AMP(1))         
      CALL HIOXXX(W(1,3),W(1,1),GURNIP,MUR,WUR,W(1,       
     &     6))                                                          
      CALL IOSXXX(W(1,2),W(1,4),W(1,6),GURNJM,AMP(2))         
      CALL JIOXXX(W(1,2),W(1,1),GZU,ZMASS,ZWIDTH,W(1,7))    
      CALL IOVXXX(W(1,3),W(1,4),W(1,7),GZNIJ,AMP(3))          
      CALL IXXXXX(P(0,1),ZERO,NHEL(1),+1*IC(1),W(1,8))        
      CALL OXXXXX(P(0,3),MNI,NHEL(3),+1*IC(3),W(1,9))         
      CALL HIOXXX(W(1,2),W(1,9),GULNIM,MUL,WUL,W(1,       
     &     10))                                                          
      CALL IOSCXX(W(1,8),W(1,4),W(1,10),GULNJP,AMP(4))        
      CALL HIOXXX(W(1,2),W(1,9),GURNIM,MUR,WUR,W(1,       
     &     11))                                                          
      CALL IOSCXX(W(1,8),W(1,4),W(1,11),GURNJP,AMP(5))        
      do i=1,ngraphs
      ...
      B_SF_nInJ_003_004 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          B_SF_nInJ_003_004 =B_SF_nInJ_003_004
