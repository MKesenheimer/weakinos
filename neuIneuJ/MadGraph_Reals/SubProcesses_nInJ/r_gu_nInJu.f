...
c the interference term and the off-shell contributions
      ...
      if( (S.ge.(MUL+dabs(MNJ))**2) .and. (MUL.ge.dabs(MNI))) then
        ...
        COUNTER35L = RATIO35L*MATRIX_GU_NINJU_RES(p_OS,NHEL,IC,0) ! generate the counter term
      endif
      ...
      if( (S.ge.(MUR+dabs(MNJ))**2) .and. (MUR.ge.dabs(MNI))) then
        ...
        COUNTER35R = RATIO35R*MATRIX_GU_NINJU_RES(p_OS,NHEL,IC,1)
      endif
      ...
      if( (S.ge.(MUL+dabs(MNI))**2) .and. (MUL.ge.dabs(MNJ))) then
        ...
        COUNTER45L = RATIO45L*MATRIX_GU_NINJU_RES(p_OS,NHEL,IC,2)
      endif
      ...
      if( (S.ge.(MUR+dabs(MNI))**2) .and. (MUR.ge.dabs(MNJ))) then
        ...
        COUNTER45R = RATIO45R*MATRIX_GU_NINJU_RES(p_OS,NHEL,IC,3)
      endif
