      SUBROUTINE SB_CL_nInJ_009_002(P1,ANS)
C  
...
C          write(*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_CL_nInJ_009_002(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_CL_nInJ_009_002(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,3),W(1,1),GB1NIP,MBL,WB1,W(1,       
     &     5))                                                          
      CALL IOSXXX(W(1,2),W(1,4),W(1,5),GB1NJM,AMP(1))         
      CALL HIOXXX(W(1,3),W(1,1),GB2NIP,MBR,WB2,W(1,       
     &     6))                                                          
      CALL IOSXXX(W(1,2),W(1,4),W(1,6),GB2NJM,AMP(2))         
      CALL JIOXXX(W(1,2),W(1,1),GZD,ZMASS,ZWIDTH,W(1,7))    
      CALL IOVXXX(W(1,3),W(1,4),W(1,7),GZNIJ,AMP(3))          
      CALL HIOXXX(W(1,2),W(1,1),GH1BB,MH1,WH1,W(1,        
     &     8))                                                          
      CALL IOSXXX(W(1,3),W(1,4),W(1,8),GH1NIJ,AMP(4))         
      CALL HIOXXX(W(1,2),W(1,1),GH2BB,MH2,WH2,W(1,        
     &     9))                                                          
      CALL IOSXXX(W(1,3),W(1,4),W(1,9),GH2NIJ,AMP(5))         
      CALL HIOXXX(W(1,2),W(1,1),GH3BB,MH3,WH3,W(1,        
     &     10))                                                          
      CALL IOSXXX(W(1,3),W(1,4),W(1,10),GH3NIJ,AMP(6))         
      CALL IXXXXX(P(0,1),BMASS,NHEL(1),+1*IC(1),W(1,11))       
      CALL OXXXXX(P(0,3),MNI,NHEL(3),+1*IC(3),W(1,12))         
      CALL HIOXXX(W(1,2),W(1,12),GB1NIM,MBL,WB1,W(1,       
     &     13))                                                          
      CALL IOSCXX(W(1,11),W(1,4),W(1,13),GB1NJP,AMP(7))        
      CALL HIOXXX(W(1,2),W(1,12),GB2NIM,MBR,WB2,W(1,       
     &     14))                                                          
     ...
     &             -AMP(   6)+AMP(   7)+AMP(   8)
      B_CL_nInJ_009_002 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          B_CL_nInJ_009_002 =B_CL_nInJ_009_002
