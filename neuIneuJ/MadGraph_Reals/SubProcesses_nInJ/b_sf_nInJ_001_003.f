      SUBROUTINE SB_SF_nInJ_001_003(P1,ANS)
C  
...
C          write(*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_nInJ_001_003(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_nInJ_001_003(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,3),W(1,1),GDLNIP,MDL,WDL,W(1,       
     &     5))                                                          
      CALL IOSXXX(W(1,2),W(1,4),W(1,5),GDLNJM,AMP(1))         
      CALL HIOXXX(W(1,3),W(1,1),GDRNIP,MDR,WDR,W(1,       
     &     6))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,9),GDLNIM,MDL,WDL,W(1,       
     &     10))                                                          
      CALL IOSCXX(W(1,8),W(1,4),W(1,10),GDLNJP,AMP(4))        
      CALL HIOXXX(W(1,2),W(1,9),GDRNIM,MDR,WDR,W(1,       
     &     11))                                                          
      ...
      B_SF_nInJ_001_003 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          B_SF_nInJ_001_003 =B_SF_nInJ_001_003
