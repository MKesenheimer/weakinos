      SUBROUTINE SMATRIX_DG_NIXJU_RES(P1,CHAN,ANS)
C  
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_DG_NIXJU_RES(P,NHEL(1,IHEL),JC(1),CHAN)            
      ...
      REAL*8 FUNCTION MATRIX_DG_NIXJU_RES(P,NHEL,IC,CHAN)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      ! both resonant channels  
        ...
        JAMP(1) = +AMP(2)+AMP(3)-AMP(5)-AMP(6)
      else
        !print*,"error in r_dg_nixju_res.f"
        !stop
      ...
      MATRIX_DG_NIXJU_RES = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_DG_NIXJU_RES =MATRIX_DG_NIXJU_RES
     &                       +ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO

#ifdef DEBUGQ
        print*,"CHAN     ", CHAN
        print*,"Matrix",MATRIX_DG_NIXJU_RES
#endif
