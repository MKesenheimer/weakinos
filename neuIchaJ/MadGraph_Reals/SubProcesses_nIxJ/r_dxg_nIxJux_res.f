      SUBROUTINE SMATRIX_DXG_NIXJUX_RES(P1,CHAN,ANS)
C  
...
C  
      ...
      common/to_amps_dxg_res/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_DXG_NIXJUX_RES(P,NHEL(1,IHEL),JC(1),CHAN)            
      ...
      REAL*8 FUNCTION MATRIX_DXG_NIXJUX_RES(P,NHEL,IC,CHAN)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      MATRIX_DXG_NIXJUX_RES = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_DXG_NIXJUX_RES =MATRIX_DXG_NIXJUX_RES
