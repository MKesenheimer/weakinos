      SUBROUTINE SB_SF_nIxJm_M_001_004(P1,ANS)
C  
...
C  
C FOR PROCESS : d u~ -> ni xj- g  
C  
C BORN AMPLITUDE IS d u~ -> ni xj-  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C          write(*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_nIxJm_M_001_004(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_nIxJm_M_001_004(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     9))                                                          
      ...
      B_SF_nIxJm_M_001_004 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          B_SF_nIxJm_M_001_004 =B_SF_nIxJm_M_001_004+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
