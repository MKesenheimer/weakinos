      SUBROUTINE SB_SF_nIxJm_M_002_003(P1,ANS)
C  
...
C          write(*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_SF_nIxJm_M_002_003(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_SF_nIxJm_M_002_003(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     5))                                                          
      CALL IOSXXX(W(1,2),W(1,4),W(1,5),GULXJM,AMP(1))         
      CALL JIOXXX(W(1,2),W(1,1),GWF,WMASS,WWIDTH,W(1,6))    
      CALL IOVXXX(W(1,3),W(1,4),W(1,6),GWNIXJ,AMP(2))         
      CALL IXXXXX(P(0,1),ZERO,NHEL(1),+1*IC(1),W(1,7))        
      CALL OXXXXX(P(0,3),MNI,NHEL(3),+1*IC(3),W(1,8))         
      CALL HIOXXX(W(1,2),W(1,8),GDLNIM,MDL,WDL,W(1,       
     &     9))                                                          
      CALL IOSCXX(W(1,7),W(1,4),W(1,9),GDLXJP,AMP(3))        
      do i=1,ngraphs
      ...
      B_SF_nIxJm_M_002_003 = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          B_SF_nIxJm_M_002_003 =B_SF_nIxJm_M_002_003+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
