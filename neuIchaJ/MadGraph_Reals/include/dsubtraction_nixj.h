...
#ifndef _EXTFUNCT_               
      double precision MATRIX_DG_NIXJU_RES   ! gives back matrix element squared 
      external MATRIX_DG_NIXJU_RES           ! from resonant diagrams in  
      double precision MATRIX_DXG_NIXJUX_RES ! dependence on CHAN:
      external MATRIX_DXG_NIXJUX_RES         ! u channel diagrams (s35 = msq^2), CHAN=0: left, CHAN=1: right
      double precision MATRIX_GD_NIXJU_RES   ! t channel diagrams (s45 = msq^2), CHAN=2: left, CHAN=3: right
      external MATRIX_GD_NIXJU_RES
      double precision MATRIX_GDX_NIXJUX_RES 
      external MATRIX_GDX_NIXJUX_RES
      double precision MATRIX_GU_NIXJD_RES
      external MATRIX_GU_NIXJD_RES
      double precision MATRIX_GUX_NIXJDX_RES
      external MATRIX_GUX_NIXJDX_RES
      double precision MATRIX_UG_NIXJD_RES
      external MATRIX_UG_NIXJD_RES
      double precision MATRIX_UXG_NIXJDX_RES
      external MATRIX_UXG_NIXJDX_RES
#endif
#endif
